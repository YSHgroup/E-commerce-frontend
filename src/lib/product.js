...
export const getIndividualCategories = (products) => {
    ...
    const individualProductCategories = getIndividualItemArray(
        productCategories
    );
...
export const getIndividualColors = (products) => {
    ...
    const individualProductColors = getIndividualColorObjectArray(
        productColors
    );
...
export const getProductsMajorColors = () => [
    // colors list just duplicated from the Laravel back end
    [255, 255, 255], [128, 128, 128], [  0,   0,   0], [120,  60,   0],
    [192,   0,   0], [255, 144,   0], [255, 212,   1], [234, 214, 189],
    [255, 202, 218], [196,   0, 170], [ 90,   0, 157], [ 38,  80, 218],
    [ 97, 195, 255], [ 48, 213, 199], [119, 231,   5], [ 51, 102,   1],
];
