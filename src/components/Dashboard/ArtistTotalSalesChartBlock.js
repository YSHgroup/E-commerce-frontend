...
const ArtistTotalSalesChartBlock = ({ chartData, totalSales, totalDownloads }) => {
        ...
        <div className="nk-block">
            <div className="card">
                <div className="card-inner">
                    ...
                    <div className="align-end gy-3 gx-5 flex-wrap">
                        <div className="nk-sale-data-group flex-md-nowrap g-4">
                            <div className="nk-sale-data">
                                <span className="amount">${ totalSales.toFixed(2) }</span>
                                <span className="sub-title">Sales</span>
                            </div>
                            <div className="nk-sale-data">
                                <span className="amount">{ totalDownloads }</span>
...
export default ArtistTotalSalesChartBlock;
