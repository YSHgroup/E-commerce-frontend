                ...
                <div className='about-overlay__content-container d-flex flex-column justify-content-between h-100'>
                    <div className='about-overlay__widget-wrapper'>
                        <div className='about-widget'>
                            ...
                            <p>
                                At 3D Infinite, we put a strong emphasis on
                                simplicity, quality and usefulness of fashion
                                products over other factors. Our fashion items
                                never get outdated. They are not short-lived as
                                normal fashion clothes.
                            </p>
                        </div>
                    </div>
                    <div className='about-overlay__contact-widget'>
                        <p className='email'>
                            <a href='mailto:contact@3dinfinite.com'>
                                contact@3dinfinite.com
                            </a>
                        </p>
